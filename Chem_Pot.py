...
for i,phi_b in enumerate(phi_bs):
	...
	for j,df in enumerate(dfs):
		...
		pl.plot(phis,Mu_s_ratio,color=colors[2],linestyle = lts[i],label=labels)
		...
		#pl.figure(3)
		pl.plot(phib10, Mu_s_ratio(0.0, phib10),'b,', label=' 0% PEG400')
		pl.plot(phib20, Mu_s_ratio(0.0, phib20),'g,', label=' 0% PEG400')
		pl.plot(phib30, Mu_s_ratio(0.0, phib30),'r,', label=' 0% PEG400')

		pl.plot(phis+0.10, Mu_s_ratio(phis, 0.10),'b-', label='10% PEG3500')
		pl.plot(phis+0.20, Mu_s_ratio(phis, 0.20),'g-', label='20% PEG3500')
		pl.plot(phis+0.30, Mu_s_ratio(phis, 0.30),'r-', label='30% PEG3500')
