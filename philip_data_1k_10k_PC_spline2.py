...
Ns = 23
Nb = 230
dfs = [-0.5,1.0,1.5,2.0,3.0]
phi_bs = [0.05, 0.10, 0.15]
phi_water_min = 0.01
gs_PEG200=[0.835,0.724,0.609,0.499,0.402]
gs_PEG1k_add= [0.720,0.574,0.488,0.407,0.278]
percs=[3,6,9,12,15,]
...
#pl.text(0.002,1.0,'Coeff:2.11,1.08,1.22', color='r')
...
pl.axis([0.0, 0.40 ,0.0, 4.0])
pl.savefig('120619_PhilipData_1k_10k_PC_spline2.eps', dpi=750)
