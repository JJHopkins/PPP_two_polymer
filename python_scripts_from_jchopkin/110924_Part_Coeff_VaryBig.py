...
#	for df in dfs:
	...
	pl.axis([-0.01, 1.0, -0.30, 100])

#font = {'size': 22}
#matplotlib.rc('font',**font)
pl.text(0.02,8.68,r'$\Delta F = 0.0$', color='r')
pl.text(0.02,6.64,r'$\Delta F = 5.0$', color='g')
pl.text(0.02,4.59,r'$\Delta F = 10.0$', color='b')
pl.text(0.02,2.55,r'$\Delta F = 15.0$', color= 'k')

pl.legend(loc='upper left')
pl.title('Partition Coeffiecent of PEG400 In Pore for Fixed $\Phi_{PEG400}$(Out) and Varied $\Phi_{PEG3500}$(Out)')
pl.xlabel('Number fraction of PEG3500 $\Phi_{PEG3500}$')
pl.ylabel('Partition Coefficient of $\Phi_{PEG400}$(In) as a function of $\Phi_{PEG400}$(Out), $\Phi_{PEG3500}$, $\Delta$F')

pl.savefig('110924_Part_Coeff_VaryBig.png')
