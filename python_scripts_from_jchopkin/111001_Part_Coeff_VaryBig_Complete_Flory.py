...
pl.text(0.02,3.68,r'$\Delta F = 0.0$', color='r')
pl.text(0.02,3.34,r'$\Delta F = 5.0$', color='g')
pl.text(0.02,2.99,r'$\Delta F = 10.0$', color='b')
pl.text(0.02,2.55,r'$\Delta F = 15.0$', color= 'k')

pl.legend(loc='upper left')
pl.title('Partition Coefficient of PEG400 In Pore for Fixed $\Phi_{PEG400}$(Out) and Varied $\Phi_{PEG3500}$')
pl.xlabel('Number fraction of PEG3500 $\Phi_{PEG3500}$')
pl.ylabel('Partition Coefficient as a function of $\Phi_{PEG400}$(Out), $\Phi_{PEG3500}$, $\Delta$F')

pl.savefig('110930_Part_Coeff_VaryBig_Complete_Generated.png')
