...
#	for df in dfs:
	...
	#pl.axis([0, 1.1, -0.25, 5.0])

#font = {'size': 22}
#matplotlib.rc('font',**font)

pl.text(0.9,1.95,r'$\Delta F = 0.0$', color='r')
pl.text(0.9,1.85,r'$\Delta F = 1.0$', color='g')
pl.text(0.9,1.75,r'$\Delta F = 5.0$', color='b')
pl.text(0.9,1.65,r'$\Delta F = 10.0$', color= 'k')

pl.legend(loc='upper right')
pl.title('Partition Coefficient for PEG400 In Pore for Varied $\Phi_{PEG400}$(Out) and Fixed $\Phi_{PEG3500}$(Out)')
pl.xlabel('Number fraction of PEG400 $\Phi_{PEG400}$(Out)')
pl.ylabel('Partition Coefficient $\Phi_{PEG400}$(In) as a function of $\Phi_{PEG400}$(Out), $\Phi_{PEG3500}$, $\Delta$F')

pl.savefig('110930_Part_Coeff_Vary_Short_Complete_Generated.png')
